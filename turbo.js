...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: 'ᴏɴʟʏ ғᴏʀ ⁩ ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴🥂',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 777888, "message": teks, "footerText": "*_©☞GOURAV⁴⁰⁴_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '918089152280-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© ☞GOURAV⁴⁰⁴_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
               case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 4: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 5: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 6: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ\n-  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                ...
                case 19: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 20: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
                case 21: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴😌"; break;
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "918089152280-1616169743@g.us",
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_©☞Gourav⁴⁰⁴_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ꪶ͢Gouravꫂ⁩⁴⁰⁴`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/918089152280?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
console.log(color('[EVAL]'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`GOURAV brooo`))
ras = budy.slice(1)
function _(rem) {
...
reply(String(e))
 ...
 if (rspndbutton) { if (rspndbutton == 'owner')
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
 			
			for (let anji of setik){
				if (budy === anji){
					result = fs.readFileSync(`./media/sticker/${anji}.webp`)
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢Gouravꫂ⁩⁴⁰⁴✘ ➫➬➭ ${anji}`, orderTitle: `𒈒 ꪶGouravꫂ⁩⁴⁰⁴ 𒈒➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢GOURAVꫂ⁩⁴⁰⁴✘ ➫➬➭ ${anju}`, orderTitle: `𒈒 ꪶ͢GOURAVꫂ⁩⁴⁰⁴ 𒈒➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 359996400, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢GOURAVꫂ⁩⁴⁰⁴✘ ➫➬➭ ${anjh}`, orderTitle: `𒈒 ꪶ͢GOURAVꫂ⁩⁴⁰⁴𒈒➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
denz.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
	    ...
	    if (isCmd && !isGroup) {console.log(color('|CMD|', 'red'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'), color(`${command} [${args.length}]`, 'cyan'), color(`${pushname}`, 'orange'), color(`${sender}`, 'deeppink'))}
	    if (!command) {console.log(color('|MSG|', 'blue'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'), color(cmd, 'cyan'), color(`${pushname}`, 'orange'), color(`${sender}`, 'deeppink'))}
		
        switch (isStc) {
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        if (!isStcSticker) return reply('Reply sticker bgsd!')
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ꪶ͢Gouravꫂ⁩⁴⁰⁴", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},
{buttonId:`owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ'},type:1},
{buttonId:`script`,buttonText:{displayText:'sᴄʀɪᴘᴛ'},type:1}
...
╚༄ ${prefix}sᴇᴅ ʟʏғᴇ
 ╔༆
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ:https://instagram.com/dark_devil_3609
 ╚༄
╔✘*ᴛʀʏ ᴀɴʏ ᴛʜɪɴɢ✘
║༊ ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ
║༊ ${prefix}ᴍᴀᴋᴇʀᴍᴇɴᴜ
...
༆☞Gourav⁴⁰⁴
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
sendButLocation(from, `${menu}`, "©☞GSɪ⁴⁰⁴", {jpegThumbnail:gambar,name:""}, [{buttonId:`about`,buttonText:{displayText:'ᴀʙᴏᴜᴛ'},type:1},{buttonId:`script`,buttonText:{displayText:'ɢɪᴛ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'alive':
denz.sendMessage(from, 'ᴡᴀɪᴛ ʙʀᴏ🙂', text, {quoted: ftok})
stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
...
┗━━━━━━━━━━━━━━━𒈒
         ī.ᴀᴍ/ꪶ͢GSꫂ⁩⁴⁰⁴`
sendButLocation(from, `${menu}`, "©☞Gouravɪ⁴⁰⁴", {jpegThumbnail:gambar,name:""}, [{buttonId:`menu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},{buttonId:`credit`,buttonText:{displayText:'ᴄʀᴇᴀᴛᴏʀ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
case 'p':
...
╚༄ᴏᴡɴᴇʀ⟼ @${dtod.split('@918089152280')[0]}             
${tampilUcapan}
${" "}
...
case 'ownermenu':
menu = `❏ 「 *ᴏᴡɴᴇʀ ᴍᴇɴᴜ* 」
╔✘${prefix}bc 「 _ᴛᴇxᴛ/ʀᴇᴘʟʏ ɢɪғ/ɪᴍɢᴀᴇ/ᴠɪᴅᴇᴏ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ_ 」
║✘${prefix}tobc 「 _ʀᴇᴘʟʏ sᴛɪᴄᴋᴇʀ/ᴀᴜᴅɪᴏ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ_ 」
║✘${prefix}return 「 _ᴊᴀᴠᴀsᴄʀɪᴘᴛ_ 」
║✘${prefix}clearall
║✘${prefix}public
║✘${prefix}self
║✘${prefix}upswteks 「 _ᴛᴇxᴛ_ 」
║✘${prefix}upswlokasi 「 _ᴛᴇxᴛ_ 」
║✘${prefix}upswaudio 「 _ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ_ 」
║✘${prefix}upswvoice 「 _ʀᴇᴘʟʏ ᴀᴜᴅɪᴏ_ 」
║✘${prefix}upswsticker 「 _ʀᴇᴘʟʏ sᴛɪᴄᴋᴇʀ_ 」
║✘${prefix}upswimage 「 _ʀᴇᴘʟʏ ɪᴍᴀɢᴇ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ_ 」
║✘${prefix}upswgif 「 _ʀᴇᴘʟʏ ɢɪғ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ_ 」
║✘${prefix}upswvideo 「 _ʀᴇᴘʟʏ ᴠɪᴅᴇᴏ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ_ 」
║✘${prefix}shutdown
║✘${prefix}offline 「 _ʀᴇᴀsᴏɴ_ 」
║✘${prefix}online
║✘${prefix}exif 「 _ɴᴀᴍᴇ|ᴀᴜᴛʜᴏʀ_ 」
║✘${prefix}setprofile 「 _ʀᴇᴘʟʏ ɪᴍᴀɢᴇ_ 」
║✘${prefix}setthumb 「 _ʀᴇᴘʟʏ ɪᴍᴀɢᴇ_ 」
║✘${prefix}setprefix 「 _ᴛᴇxᴛ_ 」
║✘${prefix}setname 「 _ᴛᴇxᴛ_ 」
║✘${prefix}setbio 「 _ᴛᴇxᴛ_ 」
║✘${prefix}addsticker 「 _ɴᴀᴍᴇ_ 」
║✘${prefix}delsticker 「 _ɴᴀᴍᴇ_ 」
║✘${prefix}addvn 「 _ɴᴀᴍᴇ_ 」
║✘${prefix}delvn 「 _ɴᴀᴍᴇ_ 」
║✘${prefix}addimage 「 _ɴᴀᴍᴇ_ 」
║✘${prefix}delimage 「 _ɴᴀᴍᴇ_ 」
║✘${prefix}bug
║✘${prefix}bugtroli
║✘${prefix}buglokasi
║✘${prefix}bughole
║✘${prefix}leave
║✘${prefix}join 「 _ɢʀᴏᴜᴘ ʟɪɴᴋ_ 」
║✘${prefix}addrespon 「 _ᴀsᴋ|ᴀɴᴡsᴇʀ_ 」
╚✘${prefix}delrespon 「 _ɴᴀᴍᴇ_ 」`
katalog(menu)
break
case 'downloadmenu':
menu = `❏ 「 *ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ* 」
...
║𒈒${prefix}lirik 「 _ɴᴀᴍᴇ_ 」
║𒈒${prefix}resepmasakan 「 _ɴᴀᴍᴇ_ 」
║𒈒${prefix}artimimpi 「 _ᴛᴇxᴛ_ 」
║𒈒${prefix}bilangangka 「 _ɴᴜᴍʙᴇʀ_ 」
║𒈒${prefix}kalkulator 「 _ɴᴜᴍʙᴇʀ_ 」
║𒈒${prefix}fancytext 「 _ᴛᴇxᴛ_ 」
║𒈒${prefix}githubstalk 「 _ᴜsᴇʀɴᴀᴍᴇ_ 」
╚𒈒${prefix}ss 「 _ᴜʀʟ_ 」`
katalog(menu)
break
case 'makermenu':
menu = `❏ 「 *ᴍᴀᴋᴇʀ ᴍᴇɴᴜ* 」
╔༊${prefix}matrix 「 _ᴛᴇxᴛ_ 」
║༊${prefix}googletxt 「 _ᴛᴇxᴛ_ 」
║༊${prefix}spiderman 「 _ᴛᴇxᴛ_ 」
║༊${prefix}express 「 _ᴛᴇxᴛ_ 」
║༊${prefix}dance 「 _ᴛᴇxᴛ_ 」
║༊${prefix}blackbird 「 _ᴛᴇxᴛ_ 」
║༊${prefix}halloween 「 _ᴛᴇxᴛ_ 」
║༊${prefix}vampire 「 _ᴛᴇxᴛ_ 」
║༊${prefix}codetxt 「 _ᴛᴇxᴛ_ 」
║༊${prefix}text3d 「 _ᴛᴇxᴛ_ 」
╚༊${prefix}warrior 「 _ᴛᴇxᴛ1|ᴛᴇxᴛ2_ 」`
katalog(menu)
break
case 'groupmenu':
menu = `❏ 「 *ɢʀᴏᴜᴘ ᴍᴇɴᴜ* 」
╔𒆜${prefix}getpict 「 _@ᴛᴀɢ_ 」
║𒆜${prefix}getbio 「 _@ᴛᴀɢ_ 」
║𒆜${prefix}promote 「 _@ᴛᴀɢ_ 」
║𒆜${prefix}demote 「 _@ᴛᴀɢ_ 」
║𒆜${prefix}antilink 「 _1/0_ 」
║𒆜${prefix}autosticker 「 _1/0_ 」
║𒆜${prefix}welcome 「 _1/0_ 」
║𒆜${prefix}antibule 「 _1/0_ 」
║𒆜${prefix}creategrup 「 _ɴᴀᴍᴇ|@ᴛᴀɢ_ 」
║𒆜${prefix}getppgc
║𒆜${prefix}getdeskgc
║𒆜${prefix}sider 「 _ʀᴇᴘʟʏ ᴛᴇxᴛ_ 」
║𒆜${prefix}hacked 「 _ᴛᴇxᴛ_ 」
║𒆜${prefix}setnamegc 「 _ᴛᴇxᴛ_ 」
║𒆜${prefix}setdeskgc 「 _ᴛᴇxᴛ_ 」
║𒆜${prefix}tictactoe「 _x/o @ᴛᴀɢ_ 」
║𒆜${prefix}delttt
║𒆜${prefix}fitnah 「 _@ᴛᴀɢ|ᴛᴇxᴛ1|ᴛᴇxᴛ2_ 」
║𒆜${prefix}kontak 「 _@ᴛᴀɢ|ɴᴀᴍᴇ_ 」
║𒆜${prefix}kontag 「 _@ᴛᴀɢ|ɴᴀᴍᴇ_ 」
║𒆜${prefix}group 「 _ᴏᴘᴇɴ/ᴄʟᴏsᴇ_ 」
║𒆜${prefix}linkgrup
║𒆜${prefix}hidetag 「 _ᴛᴇxᴛ_ 」
║𒆜${prefix}sticktag 「 _ɴᴀᴍᴇ sᴛɪᴄᴋᴇʀ_ 」
╚𒆜${prefix}totag 「 _ʀᴇᴘʟʏ ᴍᴇᴅɪᴀ_ 」`
katalog(menu)
break
case 'othermenu':
menu = `❏ 「 *ᴏᴛʜᴇʀ ᴍᴇɴᴜ* 」
╔𒋨${prefix}slots
║𒋨${prefix}suit 「 _sᴄɪssᴏʀs/sᴛᴏɴᴇ/ᴘᴀᴘᴇʀ_ 」
║𒋨${prefix}tag「 _ɴᴜᴍʙᴇʀ_ 」
║𒋨${prefix}tagme
║𒋨${prefix}tts 「 _ᴛᴇxᴛ_ 」
║𒋨${prefix}readmore 「 _ᴛᴇxᴛ1|ᴛᴇxᴛ2_ 」
║𒋨${prefix}fitnahpc 「 _ɴᴜᴍʙᴇʀ|ᴛᴇxᴛ1|ᴛᴇxᴛ2_ 」
║𒋨${prefix}chat 「 _ɴᴜᴍʙᴇʀ|ᴛᴇxᴛ_ 」
║𒋨${prefix}fdeface 「 _ʀᴇᴘʟʏ ɪᴍɢ|ᴛᴇxᴛ1|ᴛᴇxᴛ2_ 」
║𒋨${prefix}listimage
║𒋨${prefix}liststicker
║𒋨${prefix}semoji 「 _ʀᴇᴘʟʏ ᴛᴏ ᴇᴍᴏᴊɪ_ 」
║𒋨${prefix}attp 「 _ᴛᴇxᴛ_ 」
║𒋨${prefix}toimg
║𒋨${prefix}mp3 「 _ʀᴇᴘʟʏ ᴛᴏ ᴠɪᴅᴇᴏ_ 」
║𒋨${prefix}mp4 「 _ʀᴇᴘʟʏ ᴛᴏ sᴛɪᴄᴋᴇʀ_ 」
║𒋨${prefix}robot 「 _ʀᴇᴘʟʏ ᴛᴏ ᴀᴜᴅɪᴏ_ 」
║𒋨${prefix}balik 「 _ʀᴇᴘʟʏ ᴛᴏ ᴀᴜᴅɪᴏ_ 」
║𒋨${prefix}bass 「 _ʀᴇᴘʟʏ ᴛᴏ ᴀᴜᴅɪᴏ_ 」
║𒋨${prefix}listvn
║𒋨${prefix}infogempa
║𒋨${prefix}pantun
║𒋨${prefix}spam 「 _ᴛᴇxᴛ|ᴀᴍᴏᴜɴᴛ_ 」
║𒋨${prefix}sharelock 「 _ᴛᴇxᴛ1|ᴛᴇxᴛ2_ 」
        ...
        if (
          ...
          hermit =
            isQuotedImage || isQuotedSticker
              ...
              : mek;
          ser = await ser.downloadMediaMessage(hermit);
          fs.writeFileSync(`./denz.jpg`, ser);
          reply("Success");
        } else {
...
break
				...
				case 'kapankah':
					...
					const kapan =['Tomorrow','The day after tomorrow','Earlier','4 Days','5 Days','6 Days','1 Week Again','2 Weeks Again','3 Weeks Again','1 Month Again','2 Months','3 Months','4 Months','5 Months','6 Months','1 Year Again','2 Years Again','3 Years Again' ,'4 more years','5 more years','6 more years','1 century more','3 more days','Never']
					const koh = kapan[Math.floor(Math.random() * kapan.length)]
					denz.sendMessage(from, 'Question : *'+kapankah+'*\n\nAnswer : '+ koh, text, { quoted: mek })
					break
         			  case 'apakah':
					apakah = body.slice(1)
					const apa =['Yes','No','Could be','Try Repeat','Ask the Chicken']
...
☞ ꪶ͢ᴊɪғɪꫂ⁩⁴⁰⁴💞
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 8888888, "message": `${yez}`, "footerText": "©☞GOURAV⁴⁰⁴", "thumbnail": fs.readFileSync('./denz.jpg'), "surface": 'CATALOG'}}, {quoted: mek})
...
break
case 'inibuatout':
reply2('Why are people out being waved, let them out, at least they dont have a quota')
break
       case 'debug':
...
if (za > 15) return reply('maximum 15')
sampai = `${za}`
batas = parseInt(sampai) + 1
cok = await denz.searchMessages(`${ve}`, from, batas,1) 
if (cok.messages.lenght < 2) return reply('Message not found!') 
if (cok.messages.length < parseInt(batas)) reply(`Found only ${cok.messages.length - 1} Massage`)
for (let i=1;i < cok.messages.length;i++) {
if (cok.messages[i].message) {
denz.sendMessage(from, `Heres the message!`, text, {quoted: cok.messages[i]}) 
}
}
} catch(e) {
console.log(e)
...
case 'fetch':
      ...
      if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
       if (args.length < 1) return reply(`Penggunaan ${prefix}autorespon on/off`)
           if (c === 'on'){
              autorespon = false
                    reply(`𝚂𝚄𝙲𝙲𝚄𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙰𝙲𝚃𝙸𝚅𝙴𝙳 𝙰𝚄𝚃𝙾𝚁𝙴𝚂𝙿𝙾𝙽`)
                } else if (c === 'off'){
                    autorespon = true
                    reply(`𝚂𝚄𝙲𝙲𝚄𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙳𝙴𝙰𝙲𝚃𝙸𝚅𝙴𝙳 𝙰𝚄𝚃𝙾𝚁𝙴𝚂𝙿𝙾𝙽`)
                } else {
                    reply(mess.error.api)
                }
                break
...
if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tag target Opponent!')
...
id = from
gilir = player2
ky_ttt.push({𝙿𝙻𝙰𝚈𝙴𝚁1,𝙿𝙻𝙰𝚈𝙴𝚁2,𝙸𝙳,𝙽𝚄𝙼𝙱𝙴𝚁,𝚃𝚄𝚁𝙽})
denz.sendMessage(from, `*🎳 𝚂𝚃𝙰𝚁𝚃 𝙰 𝚃𝙸𝙲𝚃𝙰𝙲𝚃𝙾𝙴 𝙶𝙰𝙼𝙴 🎲*

[@${player2.split('@')[0]}] Challenge you to become a Game opponent🔥
𝚃𝚈𝙿𝙴 Y/N to accept or reject the game

𝚃𝚈𝙿𝙴 ${prefix}delttc , To Reset Games In The Group!`, text, {contextInfo: {mentionedJid: [player2]}})
break
                case 'delttt':
                case 'delttc':
if (!isGroup) return reply(mess.only.group)
...
if (error){ return reply('_[ ! ] Error Found Error Or Result Not Found_')}
else {
var gugIm = result
...
*Whare* : ${res.attributes.mana}
*Wheres Regan* : ${res.attributes.mana_regen}
...
return reply('_[ ! ] Error rusult not found_') 
}) 
...
break
case 'mediafire':
if (args.length < 1) return reply('link give? ')
if(!isUrl(args[0]) && !args[0].includes('mediafire')) return reply(mess.error.api)
if (Number(filesize) >= 30000) return reply(`*Name :* ${res[0].nama}
*size :* ${res[0].size}
*Link :* ${res[0].link}
...
result = `*Name :* ${res[0].nama}
*size :* ${res[0].size}

_File is sending, Please wait_`
reply(result)
sendFileFromUrl(res[0].link, document, {mimetype: res[0].mime, filename: res[0].nama, quoted: mek})
break
				case 'kalkulator':
				 var mtk = body.slice(12)
				 text = `${mtk} = ${Math_js.evaluate(mtk)}`
				 reply(text)
				 break
				case 'translate':
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    denz.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
				...
				case 'readmore':
                    ...
                    case 'delchat':
                    if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
                reply('succuss chat deleted' + from)
                await sleep(4000)
...
case 'tts':
         ...
         break
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
                   if (!isBotGroupAdmins) return reply(mess.only.Badmin)
                   reply(`Succuss opening group ${groupName}`)
				...
				if (Number(argzi[1]) >= 50) return reply('most!')
...
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
                    ...
                    reply(`Succuss upload image:\n${teksyy}`)
                        break
					case 'shutdown':
					if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				reply2('ʙʏᴇ ꪶ͢GOURAVꫂ⁩⁴⁰⁴💔')
				await sleep(1000)
...
break
			...
			if (args.length < 1) return reply(`Use ${prefix}chat 91xxxx|text`)
            var pc = body.slice(6)
...
𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙲𝙷𝙰𝚃 : ${privat.length}
𝙶𝚁𝙾𝚄𝙿 𝙲𝙷𝙰𝚃 : ${groups.length}
𝚃𝙾𝚃𝙰𝙻 𝙲𝙷𝙰𝚃 : ${totalChat.length}
𝚂𝙿𝙴𝙴𝙳 : ${latensi.toFixed(4)} second
𝚁𝚄𝙽𝚃𝙸𝙼𝙴 : ${kyun(uptime)}
𝙱𝙰𝚃𝚃𝙰𝚁𝚈 : ${baterai.battery}
𝙲𝙷𝙰𝚁𝙶𝙴𝙳 : ${baterai.isCharge}
𝙼𝙾𝙳𝙴 : ${publik ? 'public' : 'self'}
𝙿𝚁𝙴𝙵𝙸𝚇 : ${multi ? 'Multi Prefix' : 'No Prefix'}
𝚄𝚂𝙰𝙶𝙴 𝙾𝙵 𝚁𝙰𝙼 : ${ram2}
𝙷𝙾𝚂𝚃𝙽𝙰𝙼𝙴 : ${os.hostname()}
𝙿𝙻𝙰𝚃𝙵𝙾𝚁𝙼 : ${os.platform()}
𝚄𝙿𝚃𝙸𝙼𝙴 : ${kyun(os.uptime())}
𝙼𝙽𝙲 : ${mnc}
𝙼𝙲𝚅 : ${mcc}
𝙳𝙴𝚅𝙸𝙲𝙴 𝙼𝙾𝙳𝙴𝙻 : ${denz.user.phone.device_model}
𝙳𝙴𝚅𝙸𝙲𝙴 𝙼𝙰𝙽𝚄𝙵𝙰𝙲𝚃𝚄𝚁 : ${device_manufacturer}
𝚆𝙰 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: ${denz.user.phone.wa_version}
𝙾𝚂 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: ${denz.user.phone.os_version}
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
              if (args.length < 1) return reply('Text?')
              reply('ᴛʜɪs ɢʀᴏᴜᴘ ʜᴀᴄᴋɪɴɢ ʙʏ  GOURAV')
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   denz.updateProfilePicture (from, tessgc)
                   await sleep(1000)
                denz.groupUpdateSubject(from, `HACKED BY Gourav`)
                await sleep(1000)
...
break
                case 'ytmp4':
						if (args.length === 0) return reply(`send orders *${prefix}ytmp4 [linkYt]*`)
						...
						break
						case 'ytsearch':
            if (!args.length) return reply('𝚆𝙷𝙰𝚃 𝚃𝙷𝙴 𝚃𝙸𝚃𝙻𝙴?')
            try {
            	reply(mess.wait)
                ...
                let hehe = `┌ ◪ *𝚈𝙾𝚄𝚃𝚄𝙱𝙴 𝚂𝙴𝙰𝚁𝙲𝙷*
└ *𝚂𝙴𝙰𝚁𝙲𝙷 𝚀𝚄𝙰𝚁𝚈:* ${input}\n\n`
                for (let i = 0; i < items.length; i++) {
                    hehe += `───────────────\n
┌ ❏ *𝚃𝙸𝚃𝙻𝙴:* ${items[i].title}
├ ❏ *𝙸𝙳:* ${items[i].id}
├ ❏ *𝚆𝙰𝚃𝙲𝙷𝙴𝙳:* ${items[i].views}
├ ❏ *𝙳𝚄𝚁𝙰𝚃𝙸𝙾𝙽:* ${items[i].duration}
└ ❏ *𝙻𝙸𝙽𝙺:* ${items[i].url}\n\n`
                }
                    ...
                    case 'play':
                            ...
                            try {
                                ...
                                .then((res) => {
                                    ...
                                    axios.get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
                                    .then(async (a) => {
                                    if (Number(filesize) >= 30000) return sendMediaURL(from, thumb, `❏ *𝙿𝙻𝙰𝚈𝙼𝙿4*\n\n❏ *𝚃𝙸𝚃𝙻𝙴* : ${title}\n❏ *𝙴𝚇𝚃* : MP4\n*Filesize* : ${filesizeF}\n*𝙻𝙸𝙽𝙺* : ${a.data}\n\n_Sorry the duration exceeds the maximum limit, please click the link above_`)
                                    const captions = `❏ *𝚈𝚃𝚖𝚙4*\n\n❏ *𝚃𝙸𝚃𝙻𝙴* : ${title}\n❏ *𝙴𝚇𝚃* : MP4\n❏ *𝚂𝙸𝚉𝙴* : ${filesizeF}\n\n❏ *𝚂𝙴𝚁𝚅𝙴𝚁* 𝚈𝚃𝚖𝚙4, 𝚆𝙰𝙸𝚃 𝙰 𝙼𝙸𝙽𝚄𝚃𝙴_`
								    sendMediaURL(from, thumb, captions)
                                    sendMediaURL(from, dl_link).catch(() => reply(mess.error.api))
                                    })
                                })
			...
			case 'ping':
               ...
               case 'img':
				...
				case 'liststicker':
					...
					teks += `\n*Total : ${setik.length}*\n\n_ᴛᴏ ɢᴇᴛ sᴛɪᴄᴋᴇʀ ᴛʏᴘᴇ sᴛɪᴄᴋᴇʀ ɴᴀᴍᴇ_`
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					denz.sendMessage(from, `ᴀᴅᴅᴇᴅ ᴛᴏ ɪᴍᴀɢᴇ ᴅᴀᴛᴀʙᴀsᴇ🥂`, MessageType.text, { quoted: mek })
					break
				case 'delimage':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					try {
				...
				case 'listimage':
					...
					teks += `\n*Total : ${imagi.length}*\n\n_ᴛᴏ ɢᴇᴛ ɪᴍᴀɢᴇ ᴛʏᴘᴇ ɪᴍᴀɢᴇ ɴᴀᴍᴇ_`
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* :  ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ☞GOURAV⁴⁰⁴
┃𒈒 *ᴄʀᴇᴀᴛᴏʀ* : @918089152280
┃𒈒 *sᴘᴇᴇᴅ* : 00065
┗━━𒆜`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: " ī.ᴀᴍ/ꪶ͢GOURAVꫂ⁩⁴⁰⁴",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg')}}})
break
case 'donate':
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ᴇʀʀᴏʀ-ᴀʟᴇʀᴛ* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ꪶ͢GOURAVꫂ⁩⁴⁰⁴",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/918089152280?text=Hi Bro"}}})
	}
    }
    }
    }
